# =============================================================================
# PILOT REVALIDATION -- STEP 1: generate a FRESH 30-subject dataset from the
...
#
# Output: simulated_denosumab_data_v2_corrected_pilot.csv
# =============================================================================
...
# PILOT: 30 subjects (not 80) -- per FLAG_STATUS.md locked pilot-gate design
n_subjects <- 30
month_h <- 30.44 * 24
...
write.csv(pk_data_pilot, "simulated_denosumab_data_v2_corrected_pilot.csv", row.names = FALSE)
cat("Saved: simulated_denosumab_data_v2_corrected_pilot.csv\n")

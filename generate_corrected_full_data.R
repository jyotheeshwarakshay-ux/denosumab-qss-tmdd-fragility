# =============================================================================
# FULL REVALIDATION -- STEP 1: generate a FRESH 80-subject dataset from the
...
#
# Output: simulated_denosumab_data_v2_corrected_full.csv
# =============================================================================
...
# FULL: 80 subjects -- matches the original study design
n_subjects <- 80
month_h <- 30.44 * 24
...
write.csv(pk_data_pilot, "simulated_denosumab_data_v2_corrected_full.csv", row.names = FALSE)
cat("Saved: simulated_denosumab_data_v2_corrected_full.csv\n")
